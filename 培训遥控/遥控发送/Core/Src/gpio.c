...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LORA_M0_Pin|LORA_M1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KEY_3_Pin KEY_2_Pin PC5 LORA_AUX_Pin */
  GPIO_InitStruct.Pin = KEY_3_Pin|KEY_2_Pin|GPIO_PIN_5|LORA_AUX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
