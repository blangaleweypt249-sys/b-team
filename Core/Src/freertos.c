...
__weak void StartCommTask(void *argument)
{
  ...
  (void)McuLink_InitTx(&huart6);
  (void)RawUartBridge_Init(&huart6, &huart7);
  ...
  for(;;)
  {
    ...
    RawUartBridge_Run();
    ScLink_Run();
    Action_UpdatePnp(pnp_link[PNP_LINK_LEFT_INDEX].trigger,
                     pnp_link[PNP_LINK_RIGHT_INDEX].trigger);
