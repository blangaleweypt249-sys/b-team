...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
  ...
  /* USER CODE BEGIN UART5_MspInit 1 */
    ...
    /* Enable the DMA IRQ only after its handle and status registers are ready. */
  ...
  */
    ...
    PD15     ------> UART9_TX
    */
    GPIO_InitStruct.Pin = UART9_RX_Pin|UART9_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PE3     ------> USART10_TX
    */
    GPIO_InitStruct.Pin = USART10_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART10;
    HAL_GPIO_Init(USART10_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USART10_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_USART10;
    HAL_GPIO_Init(USART10_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART9_MspDeInit 0 */
    ...
    PD15     ------> UART9_TX
    */
    HAL_GPIO_DeInit(GPIOD, UART9_RX_Pin|UART9_TX_Pin);
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PE3     ------> USART10_TX
    */
    HAL_GPIO_DeInit(GPIOE, USART10_RX_Pin|USART10_TX_Pin);
