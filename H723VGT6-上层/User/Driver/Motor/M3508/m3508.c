...
static int32_t M3508_EncoderDelta(uint16_t encoder,
                                  uint16_t previous_encoder)
{
    int32_t delta;
...
static void M3508_BeginPositionTrajectory(m3508_context_t *context,
                                           float position_rad)
{
    float distance_rad;
...
static void M3508_UpdatePositionTrajectory(m3508_context_t *context,
                                            float dt_s)
{
    float tau;
    float tau2;
...
static void M3508_UpdateSpeedRamp(m3508_context_t *context,
...
static void M3508_FailAutoTune(m3508_context_t *context)
{
...
static float M3508_AutoTuneStep(m3508_context_t *context,
                              ...
                              uint32_t tick_ms)
{
    ...
    if ((context == NULL) || !M3508_IsFinite(relay_current_a) ||
        ...
        ((tick_ms - feedback.updated_at_ms) > m3508_cfg.feedback_timeout_ms) ||
