...
#ifndef J4310_H
#define J4310_H /**< 防止 j4310.h 被重复包含。 */
...
#define J4310_MAX_MOTOR_COUNT  16U /**< J4310 驱动可同时管理的电机数量。 */
...
typedef struct
{
    float position_max_rad; /**< J4310 MIT 位置字段的绝对值映射上限，单位：弧度。 */
    float velocity_max_rad_s; /**< J4310 MIT 速度字段的绝对值映射上限，单位：弧度每秒。 */
    float torque_max_nm; /**< J4310 MIT 转矩字段的绝对值映射上限，单位：牛米。 */
} j4310_limits_t;
...
typedef struct
{
    ...
    uint8_t mos_temperature_c; /**< J4310 功率管反馈温度，单位：摄氏度。 */
    uint8_t rotor_temperature_c; /**< J4310 转子反馈温度，单位：摄氏度。 */
...
typedef struct
{
    bool enabled; /**< J4310 在线 MIT 调参是否启用。 */
