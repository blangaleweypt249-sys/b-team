...
typedef enum
{
    VOFA_FAMILY_M2006, /**< 当前会话控制 M2006 电机。 */
    VOFA_FAMILY_M3508, /**< 当前会话控制 M3508 电机。 */
    VOFA_FAMILY_COUNT /**< VOFA 支持调试的 DJI 电机系列数量。 */
} vofa_family_t;

/** 选择 VOFA 调试会话下发给电机的控制模式。 */
typedef enum
{
    VOFA_MODE_STOP, /**< 停止输出。 */
    VOFA_MODE_CURRENT, /**< 按目标电流控制。 */
    VOFA_MODE_SPEED, /**< 按目标转速闭环控制。 */
    VOFA_MODE_POSITION /**< 按目标位置闭环控制。 */
} vofa_mode_t;
