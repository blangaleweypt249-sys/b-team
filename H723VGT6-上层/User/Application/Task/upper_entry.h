...
/* 遥控输入模式：两种模式均使用右侧 PD13..PD10；模式 0 追加自动流程。 */
#define UPPER_REMOTE_INPUT_MODE_AUTO             0U
#define UPPER_REMOTE_INPUT_MODE_MANUAL           1U
#ifndef UPPER_REMOTE_INPUT_MODE
#define UPPER_REMOTE_INPUT_MODE                  UPPER_REMOTE_INPUT_MODE_AUTO
#endif

#if ((UPPER_REMOTE_INPUT_MODE != UPPER_REMOTE_INPUT_MODE_AUTO) && \
     (UPPER_REMOTE_INPUT_MODE != UPPER_REMOTE_INPUT_MODE_MANUAL))
#error "UPPER_REMOTE_INPUT_MODE must be AUTO(0) or MANUAL(1)"
#endif
...
#define UPPER_REMOTE_PD9_SECOND_GATE_DEG            55.0f
#define UPPER_REMOTE_PD10_FIRST_GRIPPER_DEG         45.0f
#define UPPER_REMOTE_PD10_SECOND_GRIPPER_DEG       125.0f

/* 自动流程时序；PD12 的 2000 ms 从发送 240 度指令时开始。 */
#define UPPER_REMOTE_FINAL_J4310_DELAY_MS           500U
#define UPPER_REMOTE_PD12_240_HOLD_MS              2000U
