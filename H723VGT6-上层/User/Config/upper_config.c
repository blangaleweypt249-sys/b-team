...
const motor_cfg_t upper_motor_cfg[UPPER_MOTOR_COUNT] =
{
    [UPPER_MOTOR_ARM_M3508_1] =
    {
        ...
        CAN_BUS_ARM_PRIMARY, NODE_FDCAN1_M3508_1,
        UPPER_CONTROL_PERIOD_MS, 0U, true
    },
    [UPPER_MOTOR_ARM_M3508_2] =
    {
        "arm_m3508_2", MOTOR_MODEL_M3508,
        CAN_BUS_ARM_PRIMARY, NODE_FDCAN1_M3508_2,
        UPPER_CONTROL_PERIOD_MS, 0U, true
    },
    [UPPER_MOTOR_ARM_M3508_3] =
    {
        "arm_m3508_3", MOTOR_MODEL_M3508,
        CAN_BUS_ARM_SECONDARY, NODE_FDCAN2_M3508_1,
        UPPER_CONTROL_PERIOD_MS, 0U, true
    },
    [UPPER_MOTOR_ARM_M3508_4] =
    {
        "arm_m3508_4", MOTOR_MODEL_M3508,
        CAN_BUS_ARM_SECONDARY, NODE_FDCAN2_M3508_2,
        UPPER_CONTROL_PERIOD_MS, 0U, true
    },
    [UPPER_MOTOR_ARM_J4310] =
    {
        "arm_j4310", MOTOR_MODEL_J4310,
        CAN_BUS_ARM_PRIMARY, NODE_ARM_J4310,
        UPPER_CONTROL_PERIOD_MS, 0U, true
    },
