...
/* Keep the existing protocol/application name as an alias for the gate. */
#define NODE_CONVEYOR_M2006     NODE_GATE_M2006
...
#define CAN_FILTER_AUX_CONVEYOR_ID    CAN_FILTER_AUX_GATE_ID
