...
static void Test_RemoteActionTargets(void)
{
    ...
    assert(UPPER_REMOTE_J4310_STALL_MIN_TORQUE_NM(
               UPPER_REMOTE_MODE_STORE2_AUTO) == 4.0f);
    assert(UPPER_REMOTE_GATE_STALL_MIN_CURRENT_A(
               UPPER_REMOTE_MODE_STORE2_AUTO) == 4.0f);
    assert(UPPER_REMOTE_GRIPPER_STALL_MIN_CURRENT_A(
               UPPER_REMOTE_MODE_STORE2_AUTO) == 4.0f);
    assert(UPPER_REMOTE_J4310_STALL_MIN_TORQUE_NM(
               UPPER_REMOTE_MODE_STORE3_AUTO) == 3.0f);
    assert(UPPER_REMOTE_GATE_STALL_MIN_CURRENT_A(
               UPPER_REMOTE_MODE_STORE2_MANUAL) == 3.0f);
    assert(UPPER_REMOTE_GRIPPER_STALL_MIN_CURRENT_A(
               UPPER_REMOTE_MODE_STORE3_MANUAL) == 3.0f);
    ...
    assert(UPPER_REMOTE_PD11_GATE_DEG == 40.0f);
    assert(UPPER_REMOTE_STORE2_PD11_GATE_DEG == 40.0f);
    ...
    assert(UPPER_REMOTE_PC0_J4310_MATCH_TOLERANCE_DEG == 0.1f);
    assert(UPPER_REMOTE_PD10_FIRST_GRIPPER_DEG == 55.0f);
    assert(UPPER_REMOTE_PD10_SECOND_GRIPPER_DEG == 135.0f);
    ...
    assert(UPPER_REMOTE_STORE2_PD11_OPEN_DELAY_MS == 1000U);
    assert(UPPER_REMOTE_STORE2_PD11_DOUBLE_CLICK_MS == 200U);
