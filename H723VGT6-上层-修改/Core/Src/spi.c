...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI3_MspInit 0 */
    ...
    PB5     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = AUX_SPI3_SCK_Pin|AUX_SPI3_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = AUX_SPI3_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_SPI3;
    HAL_GPIO_Init(AUX_SPI3_MOSI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB5     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, AUX_SPI3_SCK_Pin|AUX_SPI3_MISO_Pin|AUX_SPI3_MOSI_Pin);
